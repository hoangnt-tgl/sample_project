...
exports.deleteManyService = exports.countByQueryService = exports.createObjIdService = exports.aggregateService = exports.deleteOneService = exports.deleteObjService = exports.updateObjService = exports.findManyService = exports.findOneService = exports.queryItemsOfModelInPageService = exports.updateManyService = exports.updateOneService = exports.queryExistService = exports.createService = void 0;
...
const queryItemsOfModelInPageService = (model, objectQuery, page = 1, pageSize = 8, sortObj = { createAt: -1 }, properties = "") => __awaiter(void 0, void 0, void 0, function* () {
    objectQuery = (0, other_services_1.removeUndefinedOfObj)(objectQuery);
    ...
    try {
        const items = 0 < currentPage && currentPage <= totalPages
            ? yield model
                .find(Object.assign({}, objectQuery), properties)
                .lean()
                .allowDiskUse(true)
                .sort(sortObj)
...
const aggregateService = (model, matchObj, groupObj = null, sortObj = null, limit = null) => __awaiter(void 0, void 0, void 0, function* () {
    const obj = [
        // First Stage
        {
            $match: matchObj
    ...
    for (let i = 0; i < obj.length; i++) {
        if (Object.values(obj[i])[0] !== null) {
            aggregateObj.push(obj[i]);
        }
    }
    const result = yield model.aggregate(aggregateObj);
    return result;
});
