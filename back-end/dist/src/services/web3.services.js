...
exports.isHex = exports.blockLatest = exports.signTransactionFullDataService = exports.sendSignedTransactionService = exports.getTransactionCountService = exports.getGasPrice = exports.isAddressService = exports.createContractService = void 0;
const { COLLECTION_CREATOR_ADDRESS } = process.env;
const createContractService = (network, contractAddress, abi) => __awaiter(void 0, void 0, void 0, function* () {
    const contract = yield new network.eth.Contract(abi, contractAddress);
    return contract;
});
exports.createContractService = createContractService;
const isAddressService = (network, address) => __awaiter(void 0, void 0, void 0, function* () {
    return yield network.utils.isAddress(address);
});
...
const sendSignedTransactionService = (network, signature) => __awaiter(void 0, void 0, void 0, function* () {
    return yield network.eth.sendSignedTransaction(signature.rawTransaction);
});
exports.sendSignedTransactionService = sendSignedTransactionService;
const isHex = (network, number) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield network.utils.isHex(number);
    return result;
});
exports.isHex = isHex;
