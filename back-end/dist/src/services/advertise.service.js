...
const getAdvertiseNFTService = () => __awaiter(void 0, void 0, void 0, function* () {
    const now = new Date(Date.now());
    const allAdvertise = yield advertiseNFT_model_1.default.find({ expireAt: { $gt: now } });
    return allAdvertise;
});
...
const checkAdvertiseNFTExistService = (itemId) => __awaiter(void 0, void 0, void 0, function* () {
    const advertise = yield (0, model_services_1.findOneService)(advertiseNFT_model_1.default, { collectionId: (0, model_services_1.createObjIdService)(itemId) });
    return advertise ? true : false;
});
