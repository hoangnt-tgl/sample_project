 ...
 *			      	POST ROUTE					        *
 ********************************************/
sellRouter.post("/create", checkUser_middlewares_1.checkUserMatchOnBlockchain, checkOther_middlewares_1.checkChainIdMiddleware, checkUser_middlewares_1.checkUserExistMiddleware, checkItem_middleware_1.checkOwnerItemMiddleware, checkItem_middleware_1.checkItemExistMiddleware, checkItem_middleware_1.checkItemSelling, sell_controllers_1.createSellController);
