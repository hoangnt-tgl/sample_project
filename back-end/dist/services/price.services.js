...
const getTokenService = (objQuery, properties = "") => __awaiter(void 0, void 0, void 0, function* () {
    let token = yield (0, model_services_1.findOneService)(token_model_1.default, objQuery, properties);
    if (!token) {
        token = yield (0, model_services_1.findOneService)(token_model_1.default, { chainId: 1, tokenSymbol: "eth" }, properties);
    }
    return token;
});
exports.getTokenService = getTokenService;
const getManyTokenService = (objQuery) => __awaiter(void 0, void 0, void 0, function* () {
    const tokens = yield (0, model_services_1.findManyService)(token_model_1.default, objQuery);
    return tokens;
});
...
const changePriceService = (from, to, weiPrice) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        to = to.toLowerCase();
        const chainId = default_constant_1.DEFAULT_CHAIN_ID || 4;
        const pair = `${from}-${to}`;
